...
# The Go app reads this file per-issuance (stepca.Client.IssueCertificate);
# establishing it here means it's ready before the app's own in-process TLS
# bootstrap (main.go) needs it for UI_TLS_MODE=stepca.
